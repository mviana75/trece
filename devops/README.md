...
```
DEPLOY_ENV=prod
DEPLOY_HOST=trece-mviana75.tangrama.com.br
DEPLOY_PORT=22
DEPLOY_USER=plone
...
prod:
  hosts:
    trece-mviana75.tangrama.com.br:
      ansible_user: root
      host: trece-mviana75
      hostname: trece-mviana75.tangrama.com.br
```
...
Deploy the stack defined in `devops/stacks/trece-mviana75.tangrama.com.br.yml` to the remote server with:
